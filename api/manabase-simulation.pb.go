...
type DeckStats struct {
	...
	LandStats     *LandStats          `protobuf:"bytes,5,opt,name=landStats,proto3" json:"landStats,omitempty"`
}
...
func (x *DeckStats) GetLandStats() *LandStats {
	if x != nil {
		return x.LandStats
	}
	return nil
...
type LandStats struct {
	...
	LandManaProduction *SimplifiedManaCost `protobuf:"bytes,1,opt,name=landManaProduction,proto3" json:"landManaProduction,omitempty"`
}

func (x *LandStats) Reset() {
	*x = LandStats{}
...
func (x *LandStats) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LandStats) ProtoMessage() {}

func (x *LandStats) ProtoReflect() protoreflect.Message {
	mi := &file_api_manabase_simulation_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LandStats.ProtoReflect.Descriptor instead.
func (*LandStats) Descriptor() ([]byte, []int) {
	return file_api_manabase_simulation_proto_rawDescGZIP(), []int{13}
}

func (x *LandStats) GetLandManaProduction() *SimplifiedManaCost {
	if x != nil {
		return x.LandManaProduction
	}
	return nil
}
...
var file_api_manabase_simulation_proto_rawDesc = []byte{
	...
	0x73, 0x73, 0x65, 0x73, 0x22, 0xea, 0x01, 0x0a, 0x09, 0x44, 0x65, 0x63, 0x6b, 0x53, 0x74, 0x61,
	...
	,
...
var file_api_manabase_simulation_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_api_manabase_simulation_proto_goTypes = []any{
	...
	(*LandStats)(nil),                // 14: manabase_simulation.LandStats
}
var file_api_manabase_simulation_proto_depIdxs = []int32{
	...
	14, // 8: manabase_simulation.DeckStats.landStats:type_name -> manabase_simulation.LandStats
	9,  // 9: manabase_simulation.LandStats.landManaProduction:type_name -> manabase_simulation.SimplifiedManaCost
	1,  // 10: manabase_simulation.ManabaseSimulator.Echo:input_type -> manabase_simulation.EchoRequest
	3,  // 11: manabase_simulation.ManabaseSimulator.SimulateDeck:input_type -> manabase_simulation.SimulateDeckRequest
	5,  // 12: manabase_simulation.ManabaseSimulator.ValidateDeckList:input_type -> manabase_simulation.ValidateDeckListRequest
	2,  // 13: manabase_simulation.ManabaseSimulator.Echo:output_type -> manabase_simulation.EchoResponse
	4,  // 14: manabase_simulation.ManabaseSimulator.SimulateDeck:output_type -> manabase_simulation.SimulateDeckResponse
	6,  // 15: manabase_simulation.ManabaseSimulator.ValidateDeckList:output_type -> manabase_simulation.ValidateDeckListResponse
